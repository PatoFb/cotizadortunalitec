...
class ToldoFeaturesOrderRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'bambalina_type.required' => 'Por favor selecciona el tipo de bambalina',
            'inclination.required' => 'Por favor selecciona la inclinación',
        ];
    }
}
