...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/logosolair2.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/logosolair2.png" sizes="32x32 48x48">
